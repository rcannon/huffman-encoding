...
class Huffman {
 public:
  ...
  // CHAR_BIT is variable imported from climits
  ...
  int decode(bool bit);
 private:
  std::vector<int> frequency_table_; // stores frequency of chars

  tree_ptr_t huffman_tree_; // stores pointer to most recently huffman tree

  void build_huffman(); // build huffman tree given freq table vals
